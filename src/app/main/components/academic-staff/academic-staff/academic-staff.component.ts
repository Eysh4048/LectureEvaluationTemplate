...
@Component({
  ...
  styleUrls: ['./academic-staff.component.scss']
})
export class AcademicStaffComponent implements OnInit {
  ...
  totalRemain: any = 0;
	...
	cardColumns: string[] = ['ID', 'firstName', 'middleName', 'lastName', 'employeeCode', 'nationality', 'gender', 'physicalAddress', 'fromWhere', 'phoneNumber','email', 'status', 'action'];
